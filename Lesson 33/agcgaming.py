...
background_image = pygame.transform.scale(pygame.image.load("Guess the Brainrot.png"), (SCREEN_WIDTH, SCREEN_HEIGHT))
ACG_Gaming_Mode = pygame.transform.scale(pygame.image.load("Guess the Brainrot.png"), (400, 300))
